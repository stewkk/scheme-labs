...
;; 1. Реализуйте процедуру (count x xs), подсчитывающую,
;; сколько раз встречается элемент x в списке xs.
...
;; которая "удаляет" из списка xs все элементы,
;; удовлетворяющие предикату pred?.
;; Примеры применения процедуры:
...
;; список из n элементов вида (x, f(x), f(f(x)), f(f(f(x))), …),
;; где f — процедура (функция) одного аргумента.
;; Примеры применения процедуры:
...
;; полученный путем вставки элемента е между элементами
...
;; 5. Реализуйте предикаты (any? pred? xs),
;; который возвращает #t, если хотя бы один из элементов
;; списка xs удовлетворяет предуикату pred?,
;; и (all? pred? xs), который возвращает #t,
;; если все элементы списка xs удовлетворяет предуикату pred?.
;; Не используйте условные конструкции,
;; вместо них используйте особенности встроенных and и or.
;; Примеры применения:
...
;; для чего напишите процедуру o,
;; принимающую произвольное число процедур одного аргумента
;; и возвращающую процедуру, являющуюся композицией
